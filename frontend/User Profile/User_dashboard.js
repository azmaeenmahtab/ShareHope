(function () {
  ...
  const CASES = {
    ...
    2: {
      ...
      desc: "Local trust supporting 14 widows in Vatara with monthly ration and school fees for their children. Registered NGO, audited annually.",
      raised: "৳ 61,500 raised", goal: "৳ 150,000", percent: 41,
      area: "Vatara, Dhaka", Category:"Financial support",
      submit: "28 Jul 2026", 
      methods: "bKash, Nagad, Bank, Cash",
      docs:["📄 Audit copy", "📄 NGO Certificate", "📄 Trust ID"]
    },
    3: {
    ...
    5: {
      ...
      submit: "25 Jul 2026", 
      methods: "bKash, Nagad, Bank, Cash",
      docs:["📄 NID copy", "📄 Organization Certificate", "📄 Hospital note"]
    }
  };
  ...
  document.querySelectorAll(".dcard").forEach((card) => {
    const id = Number(card.getAttribute("data-case"));
